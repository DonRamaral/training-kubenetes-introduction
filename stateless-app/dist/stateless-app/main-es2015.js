...
let AppComponent = class AppComponent {
    constructor(voteService, router) {
        this.voteService = voteService;
        this.router = router;
        this.sub = this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(e => e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]))
            .subscribe((s) => {
...
let VoteComponent = class VoteComponent {
    constructor(voteService, route, router) {
        this.voteService = voteService;
        this.route = route;
        this.router = router;
